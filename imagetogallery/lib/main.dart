  ...
  Future getImage() async {
    ...
    setState(() {
      if (pickedFile != null) {
        ...
        String path =
            "/storage/emulated/0/DCIM/Camera/${Random().nextInt(1000000)}.jpg";
        // File file = File(path);
        File file = _image.copySync(path);
        print(file);
      } else {
    ...
    return Scaffold(
      ...
      body: Center(
        ...
        child: Column(
          ...
          children: <Widget>[_image != null ? Image.file(_image) : Text("???")],
        ),
      ),
